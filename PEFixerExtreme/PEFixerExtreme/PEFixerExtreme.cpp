...
int main()
{
    ...
    auto* f = new CFile("C:\\Users\\Joao\\Desktop\\Nova pasta (3)\\peparser\\explorer.exe", "rb+");
    auto* pLog = new CProgramLogger("C:\\Users\\Joao\\Desktop\\Nova pasta (3)\\peparser\\log.txt");

    bool opCarrigirAsCaracteristicas = true;
    bool opCorrigirAlinhamentosRaw = true;
    bool opCorrigirTamanhoDaImagem = true;
    bool opCorrigirOptionalHeader = true;
    bool opCorrigiroTamanhoInitDATA = true;
    bool opCorrigirInformacoesVersao = true;
    bool opCorrigirTamanhoDoHeapDaStack = true;
    bool opCorrigirDiretorioData = true;
    bool opisDLL = false;
